...
from controller.CashBookHandlers import CashbooksHandler, CashbookShowHandler, CashbookCreateHandler, DeleteHandler
from controller.CashBookHandlers2 import CashbooksHandler2, CashbookShowHandler2, CashbookCreateHandler2
...
application = tornado.web.Application([
    ...
    (r"/cashbook/fixed", CashbookCreateHandler2), # 現金出納帳 新規作成
    (r"/cashbook/show/([0-9]+)", CashbookShowHandler), # 現金出納帳 詳細
    (r"/cashbook/delete/([0-9]+)", DeleteHandler),
